...
// 2. Query / ambil data
$query = mysqli_query($cn,"SELECT * FROM mahasiswa ORDER BY id DESC");

// 3. Tampung data query pada variabel baru
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <input type="text" name="keyword" placeholder="Cari Mahasiswa.." class="form-control"
                                    autofocus autocomplete="off" value="<?php echo $_['keyword'];?>">
                            </div>

                            <div class=" col-md-6">
                                <button type="submit" class="btn btn-success w-100" name="cari">Cari
                                    Data</button>
                            </div>
                        </div>
                    </form>
